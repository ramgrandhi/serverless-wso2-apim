...
- [Node.js 14 and lower](https://nodejs.org/en/about/releases/)
...
> | `visibility`                          | Supports `PUBLIC` (Visible to everyone) and `PRIVATE` (Visible to current tenant). Kept in the api for backwards compatibility. Please use fields for `subscriberVisibility` and `publisherVisibilityControl`.                                                                                                              |                                                                                    `PUBLIC` |
...
> | `publisherVisibilityControl`          | Visibility of the API in the publisher portal. Supports `NONE` (Visible to all publishers/creators) and `RESTRICTED` (Visible to publishers/creators with the roles that you specify. You should provide the roles in the `publisherVisibilityControlRoles`.).                                                              |                                                                                `RESTRICTED` |
> | `publisherVisibilityControlRoles`     | The user roles that are able to access the API in Store. Only applicable in combination with `publisherVisibilityControl`.                                                                                                                                                                                                  |                                                                                     `admin` |
