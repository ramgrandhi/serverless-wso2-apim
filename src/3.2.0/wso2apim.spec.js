...
describe("wso2apim-3.2.0", () => {
  ...
  describe("uploadCert()", () => {
    ...
    it("should handle a faulty response", async () => {
      ...
      expect(
        uploadCert(wso2APIM, "xxx", "alias", wso2APIM.apidefs[0].backend.http.certChain, wso2APIM.apidefs[0].backend.http.baseUrl)
      ).rejects.toThrow();
    });
  });
  ...
  describe("updateAPIDef()", () => {
    it("should handle a successful response", async () => {
      const response = await updateAPIDef(wso2APIM, "xxx", wso2APIM.apidefs[0], apiId);
  ...
  describe("removeClientCert()", () => {
    it("should handle a successful response", async () => {
      const response = await removeClientCert(wso2APIM, "xxx", "alias", "123");
  ...
  describe("updateCert()", () => {
    it("should handle a successful response", async () => {
      const response = await updateCert(wso2APIM, "xxx", "alias", wso2APIM.apidefs[0].backend.http.certChain);
  ...
  describe("updateClientCert()", () => {
    ...
    it("should handle a faulty response", async () => {
      ...
      expect(
        updateClientCert(wso2APIM, "xxx", "alias", wso2APIM.apidefs[0].securityScheme.mutualssl.clientCert, "123")
      ).rejects.toThrow();
    });
  });
  ...
  describe("listClientCertInfo()", () => {
    it("should handle a successful response", async () => {
      const response = await listClientCertInfo(wso2APIM, "xxx", "alias", "123");
