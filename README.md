...
> | `swaggerSpec`                             | Swagger 2.0 / OpenAPI 3.0 specification in YML                                                                                                                                                                                                                                                                              |                                                                                             |
> | `businessInformation`                     | Optional, for creating and assigning the correct CMDB items                                                                                                                                                                                                                                                                 |                                                                                             |
> | `businessInformation.businessOwner`       | String value containing supportgroup for ticketing                                                                                                                                                                                                                                                                          |                                                                                             |
> | `businessInformation.technicalOwner`      | String value, containing the configuration group that is responsible for maintining the api                                                                                                                                                                                                                                 |                                                                                             |
> | `businessInformation.businessOwnerEmail`  | String value, containing (group) email address of the business owner                                                                                                                                                                                                                                                        |                                                                                             |
> | `businessInformation.technicalOwnerEmail` | String value, containing (group) email address of the technical owner owner                                                                                                                                                                                                                                                 |                                                                                             |
